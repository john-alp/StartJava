package сourses.nailAlishev.JavaNeil.JavaCollectionsFramework02.LinkedList_004;
 ...
 *  Значения гораздо быстрее добавлять в ArrayList, чем LinkedList (в примере в два раза), по дефолту, в конец листа.
 *  Считывание по идексу, ArrayList быстрее в 1000 раз!
 *
 * list.add(0, 100) (index, object) добавляет значения в начало списка. Тепербь всё наоборот,
 *  так как ArrayList нужно каждый раз перезаписывать внутрений массив.
